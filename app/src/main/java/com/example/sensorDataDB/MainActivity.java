...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    public void writeDataToCsv () {
        ...
        try {
                ...
                fileWriter.append("ID,AX,AY,AZ,GX,GY,GZ,time\n");
                ...
                while (cursor.moveToNext()) {
                    ...
                    String timestamp = cursor.getString(7);  // Retrieve the timestamp
                    ...
                    fileWriter.append(",");
                    fileWriter.append(timestamp).append("\n");
                }
                fileWriter.close();
        } catch (Exception e) {
            e.printStackTrace();
